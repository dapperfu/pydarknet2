...
@pytest.mark.skipif(
    not os.path.exists("/usr/local/cuda"), reason="Requires CUDA to be installed."
)
@pytest.mark.skipif(
    not os.path.exists("/usr/local/cuda/lib64/libcudnn.so"),
    reason="Requires cudNN to be installed.",
)
